...
I then added 2 new characters to parameters and allowed for 8 character ID's instead of 6. After all of that I changed IsHit() to allow for a higher weight value to decrease your knockback and the new invincibility variable to cancel a move hitting
...
I then added more functionality for invincibility, adding a cooldown so dodge couldn't be spammed, making you gain 5 secondas of invincibility on death and adding a dodge move
