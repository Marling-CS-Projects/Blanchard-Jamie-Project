...
| ---- | ----------------------------------------- | -------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | --------- |
| 1    | Check everything displays correctly       | To have transparency effects, flipping code and everything to display correctly  | DrawRect didn't draw a full rectangle, instead it only drew the outline and despite my optimisations the screen still flashed when drawing a new frame | Pass      |
| 2    | Window resizing                           | The sprites to scale with the size of the window                                 | As expected                                                                                                                                            |           |
| 3    | Sound                                     | Check that sound files play properly                                             | Playing a second sound (such as the hit sound) stopped the first sound from playing                                                                    |           |
