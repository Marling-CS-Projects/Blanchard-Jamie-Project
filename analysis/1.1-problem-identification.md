...
* Video games sales increased by 20% in 2020 as opposed to x in 2019 (new source or find graph of sales over time)
* Nintendo profits were getting 5 times the profits they normally achieve [(Epstein, 2020)](../reference-list.md). INACCURATE

<figure><img src="../.gitbook/assets/image (5) (1).png" alt=""><figcaption><p>REPLACE WITH SALES STATS</p></figcaption></figure>
