...
Each player will have 5 lives and spawn on opposite sides of the stage. Both players' objective is to hit their opponent off the map. This is done by hitting your opponent to deal damage and knockback to them. Knockback will be represented in % and the knockback you take is directly proportional to your %. This is only true for scalar knockback, but moves also deal fixed knockback which doesn't increase based on %. This means the knockback equation is **total knockback=fixed knockback + scalar knockback\*percent/100**. Once a player goes off the screen border they've lost a life, and after a brief period respawn at the centre. Once one player runs out of lives, the game ends and the other player wins. If you're knocked off the stage but live, you can try to recover using your mid-air jump (or jumps depending on the character) and your upwards special.
...
There will be no online multiplayer, but there will be local multiplayer. This in combination with tools like Parsec can allow people to play online multiplayer at no cost to them or me, however this creates extra work for the user and is dependant on external tools.
