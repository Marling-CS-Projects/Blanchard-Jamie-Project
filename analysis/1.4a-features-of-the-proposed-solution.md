...
Each player will have 5 lives and spawn on opposite sides of the stage. Both players' objective is to hit their opponent off the map. This is done by hitting your opponent to deal damage and knockback to them. Knockback will be represented in % and the knockback you take is directly proportional to your %. Once a player goes off the screen border they've lost a life, and after a brief period respawn at the centre. Once one player runs out of lives, the game ends and the other player wins. If you're knocked off the stage but live, you can try to recover using your mid-air jump (or jumps depending on the character) and your upwards special.

<figure><img src="../.gitbook/assets/image (16).png" alt="" width="501"><figcaption><p><a href="../reference-list.md">Smash Ultimate's rules (Nintendo, 2023)</a></p></figcaption></figure>
...
{% hint style="info" %}
W (Player 1) or ↑ (Player 2) will be used for a directional input of up

A (Player 1) or ← (Player 2) will be used to move left and for a directional input left

D (Player 1) or → (Player 2)will be used to move right and for a directional input right

S (Player 1) or ↓ (Player 2) will be used to fast fall and for a directional input of down
{% endhint %}
...
{% hint style="info" %}
G (Player 1) or L (Player 2) will be used to jump
{% endhint %}
...
F will be used for light attacks

T will be used for heavy attacks

H will be used for special attacks

Left Shift will be used to dodge
{% endhint %}

{% hint style="info" %}
Player 2

K will be used for light attacks

O will be used for heavy attacks

";" will be used for special attacks

N will be used to dodge
{% endhint %}
...
<figure><img src="../.gitbook/assets/image (12).png" alt=""><figcaption><p>Screenshot from Rivals of Aether</p></figcaption></figure>
