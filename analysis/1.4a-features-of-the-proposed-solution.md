...
Each player will have 5 lives and spawn on opposite sides of the stage. Both players' objective is to hit their opponent off the map. This is done by hitting your opponent to deal damage and knockback to them. Knockback will be represented in % and the knockback you take is directly proportional to your %. Once a player goes off the screen border they've lost a life, and after a brief period respawn at the centre with 0%. Players respawn with invincibility but this invincibility is lost after using a move.  If you're knocked off the stage but survive, you can try to recover using your mid-air jump (or jumps depending on the character) and your upwards special. The game ends when one player runs out of lives or a 10 minute timer that starts once the game starts runs out. At this point the player with the most lives wins.&#x20;
...
There will be an AI that controls the playable characters and tells the game which inputs they should perform. This provides the player with a single-player experience that should be challenging but beatable.
...
The stage will be randomly selected out of a select few. The few will be bright colours that don't overlap with the character's colours to be clearly visible. It will have a main platform that covers the centre of the screen and walls that go further down that can be jumped off. The background will be a darker colour than the characters to highlight them. \
The camera will be a fixed camera that showcases the entire stage and boundary of the map to show players all the visual information they need.
...
I will use publically available sound assets to add music and sound effects for hit and death. This will amplify the feel of the game as music can make the players feel more immersed with the game, and having sound effects on hit makes each hit feel more impactful by providing more stimuli.
