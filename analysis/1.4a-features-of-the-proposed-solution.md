...
{% hint style="info" %}
F (Player 1) or K (Player 2) will be used for light attacks

T (Player 1) or O (Player 2) will be used for heavy attacks

H (Player 1) and ";" (Player 2) will be used for special attacks

Left Shift (Player 1) and N (Player 2) will be used to dodge
{% endhint %}

#### Pause

I'm going to add a pause menu that's bound to Esc or Enter. This will pause the state of the game, display both players' controls and have an option to restart the game or go to the character select screen.
