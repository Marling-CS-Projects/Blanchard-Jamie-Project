...
{% hint style="info" %}
W or ↑ will be used for a directional input of up

A or ← will be used to move left and for a directional input left

D or →will be used to move right and for a directional input right

S or ↓ will be used to fast fall and for a directional input of down
{% endhint %}
...
{% hint style="info" %}
F or K will be used for light attacks

T or O will be used for heavy attacks

H and ";" will be used for special attacks

Shift and N will be used to dodge
{% endhint %}
