...
Each player will have 5 lives and spawn on opposite sides of the stage. Both players' objective is to hit their opponent off the map. This is done by hitting your opponent to deal damage and knockback to them. Knockback will be represented in % and the knockback you take is directly proportional to your %. Once a player goes off the screen border they've lost a life, and after a brief period respawn at the centre. If you're knocked off the stage but survive, you can try to recover using your mid-air jump (or jumps depending on the character) and your upwards special. The game ends when one player runs out of lives or a 10 minute timer that starts once the game starts runs out. At this point the player with the most lives wins.&#x20;
