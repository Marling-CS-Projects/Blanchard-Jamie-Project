...
Once a player goes off the screen border they'll lose a life. After a brief period they will respawn at the centre with 0%. Players will respawn with invincibility. This invincibility is lost after using a move or 5 seconds have passed.  If you're knocked off the stage but survive, you can try to recover using your mid-air jump (or jumps) and your upwards special. The game ends when one player runs out of lives or a 10 minute timer that starts once the game starts runs out. At this point the player with the most lives (or lowest percent) wins.&#x20;
