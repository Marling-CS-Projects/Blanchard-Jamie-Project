...
<figure><img src="../.gitbook/assets/controls.png" alt=""><figcaption><p>Finalised conrols on a UK English keyboard layout</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/Back Air.gif" alt=""><figcaption><p><a href="../reference-list.md">Mario's Backward Aerial in Super Smash Bros. Ultimate, a fast move with a large hitbox and low reward (SmashWiki, 2023)</a><a href="../reference-list.md">Mario's Backward Aerial in Super Smash Bros. Ultimate, a fast move with a large hitbox and low reward (SmashWiki, 2023)</a></p></figcaption></figure>
...
Being a .exe file once compiled means it only has Windows support without compatibility layers. However, as I can make the code open source people should be able to compile it themselves.
